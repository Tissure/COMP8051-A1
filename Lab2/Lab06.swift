...
class RotatingCrateLight: SCNScene {
    ...
    func handleDrag(offset: CGSize) {
        diffuseLightPos = SCNVector4(offset.height, offset.width, 0, Double.pi/2) // Get the width and height components of the CGSize, which only gives us two, and put them into the x and y rotations of the flashlight
    }
}
